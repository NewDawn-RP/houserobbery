...
Config.Rewards = {
    ...
    { items = { 'ring' }, togive = { min = 1, max = 1 }, toget = { min = 0, max = 2 } },
    { items = { 'necklace' }, togive = { min = 1, max = 1 }, toget = { min = 2, max = 7 } },
    { items = { 'black_money' }, togive = { min = 1, max = 1 }, toget = { min = 0, max = 343 } },
    { items = { "jewels" }, togive = { min = 1, max = 1 }, toget = { min = 2, max = 7 } },
    { items = { "diamond" }, togive = { min = 1, max = 1 }, toget = { min = 0, max = 1 } },
}
